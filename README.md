...
This module provides the hint functionality and utility for both the [Blitz](https://github.com/putyourlightson/craft-blitz) and [Blitz Recommendations](https://github.com/putyourlightson/craft-blitz-recommendations) plugins for [Craft CMS](https://craftcms.com/).  
